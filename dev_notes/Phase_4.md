...
The line `Mockito.when(...).thenReturn(...)` is called **stubbing** and is used to return a fake response to verify whether the controller is accepting the request properly and is giving the expected response<br>
